...
export async function POST(request: Request) {
  ...
  //   const prompt = `
  // a young beautiful school teenager using a laptop on a desk lofi, chill, pop, ${timeLabel}, with ${weatherDescription}.
  // --sref ${ghost_style}::10 ${k_style}::5 ${shinkai_style}::20 --v 6
  // `;
